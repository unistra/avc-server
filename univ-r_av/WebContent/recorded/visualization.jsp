	    ...
	    <div class="contents">
			...
			<div class="smil">
				<object name="video" classid="clsid:CFCDAA03-8BE4-11cf-B84B-0020AFBBCCFA" width="970" height="550">
					<param name="src" value="http://stagiaire1.u-strasbg.fr/coursv2/smiltest/cours7.smil">
					<param name="controls" value="ImageWindow">
					<param name="console" value="console">
					<param name="autostart" value="true">
					<param name="wmode" value="transparent">
					<embed type="audio/x-pn-realaudio-plugin" id="video" src="http://stagiaire1.u-strasbg.fr/coursv2/smiltest/cours7.smil" width="970" height="550" align="middle" controls="ImageWindow" console="console" autostart="true" wmode="transparent">
				</object>
				<br>
