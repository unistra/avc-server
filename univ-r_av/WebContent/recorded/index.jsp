	    		...
	    		<table cellspacing="0">
	    			...
	    			<tr class="row2">
	    				...
	    				<td>	    				
		    				...
		    				<div id="row2col1link">
		    					<a href="javascript:switchDetails('row2')">[+] plus de détails</a>
		    				</div>	    				
		    				<div id="row2col1details" class="hidden">
			    				<b>Formation : </b>Droit des escrocs<br>
			    				<b>Sujet : </b>Comment contourner la loi<br>
			    				<a href="javascript:switchDetails('row2')">[-] moins de détails</a>
		    				</div>	    				
	    				</td>
	    				<td>
	    			...
	    			<tr class="row1">
	    				...
	    				<td>	    				
		    				...
		    				<b>Enseignant : </b>René de Quenaudon (LS6)<br>
		    				<div id="row3col1link">
		    					<a href="javascript:switchDetails('row3')">[+] plus de détails</a>
		    				</div>	    				
		    				<div id="row3col1details" class="hidden">
			    				<b>Formation : </b>Droit des escrocs<br>
			    				<b>Sujet : </b>Comment contourner la loi<br>
			    				<a href="javascript:switchDetails('row3')">[-] moins de détails</a>
		    				</div>	    				
	    				</td>
	    				<td>
		    				<b>Date : </b>11/04/2007 <br>
	    			...
	    			<tr class="row2">
	    				...
	    				<td>	    				
		    				...
		    				<b>Enseignant : </b>René de Quenaudon (LS6)<br>
		    				<div id="row4col1link">
		    					<a href="javascript:switchDetails('row4')">[+] plus de détails</a>
		    				</div>	    				
		    				<div id="row4col1details" class="hidden">
			    				<b>Formation : </b>Droit des escrocs<br>
			    				<b>Sujet : </b>Comment contourner la loi<br>
			    				<a href="javascript:switchDetails('row4')">[-] moins de détails</a>
		    				</div>	    				
	    				</td>
	    				<td>
		    				<b>Date : </b>11/04/2007 <br>
	    			...
	    			<tr class="row1">
	    				...
	    				<td>	    				
		    				...
		    				<b>Enseignant : </b>René de Quenaudon (LS6)<br>
		    				<div id="row5col1link">
		    					<a href="javascript:switchDetails('row5')">[+] plus de détails</a>
		    				</div>	    				
		    				<div id="row5col1details" class="hidden">
			    				<b>Formation : </b>Droit des escrocs<br>
			    				<b>Sujet : </b>Comment contourner la loi<br>
			    				<a href="javascript:switchDetails('row5')">[-] moins de détails</a>
		    				</div>	    				
	    				</td>
	    				<td>
		    				<b>Date : </b>11/04/2007 <br>
	    			...
	    			<tr class="row2">
	    				...
	    				<td>	    				
		    				...
		    				<b>Enseignant : </b>René de Quenaudon (LS6)<br>
		    				<div id="row6col1link">
		    					<a href="javascript:switchDetails('row6')">[+] plus de détails</a>
		    				</div>	    				
		    				<div id="row6col1details" class="hidden">
			    				<b>Formation : </b>Droit des escrocs<br>
			    				<b>Sujet : </b>Comment contourner la loi<br>
			    				<a href="javascript:switchDetails('row6')">[-] moins de détails</a>
		    				</div>	    				
	    				</td>
	    				<td>
		    				<b>Date : </b>11/04/2007 <br>
