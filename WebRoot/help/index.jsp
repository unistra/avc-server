...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="../files/styles/style1/css/help.css">
	
	<!--[if IE]>
		<link rel="stylesheet" type="text/css" href="../files/styles/style1/css/styles_ie.css" media="screen" />
	<![endif]-->
	<!--[if lte IE 6]>
		<link rel="stylesheet" type="text/css" href="../files/styles/style1/css/help_ie6.css" media="screen" />
	<![endif]-->
