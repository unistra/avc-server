...
/usr/bin/mplayer -vo null -vc null -ao pcm:fast:file=./../$2.wav ./../$2.mp3
/usr/bin/faac -b 64k -w -o ./../$2.m4a ./../$2.wav

# Convert avi+aac into mp4
/usr/bin/ffmpeg -v -1 -i ./../$2.m4a -acodec copy -i ./../$2_tmp.avi -vcodec libx264 -vpre normal -crf 27 -y ./../$2_videoslide_tmp.mp4 -threads 0 > /dev/null

# Adds mov atom
/usr/bin/qt-faststart ./../$2_videoslide_tmp.mp4 ./../$2_videoslide.mp4
