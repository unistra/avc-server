...
public class DatabaseImplTest {
	...
	public void setUp() throws Exception {
		...
		try {
			...
			st.executeUpdate("CREATE TABLE \"user\" (userid INTEGER GENERATED BY DEFAULT AS SEQUENCE user_userid_seq,login VARCHAR(255) NOT NULL,email VARCHAR(255),firstname VARCHAR(255),lastname VARCHAR(255),profile VARCHAR(255),establishment VARCHAR(255),password VARCHAR(255),passwordtype VARCHAR(255),type VARCHAR(255),activate BOOLEAN,etp VARCHAR(255),resetcode VARCHAR(255),resetcodetype VARCHAR(255),dateresetcode TIMESTAMP);");
			//course
	...
	public void testUserMethods() {
		//Method addUser
		User user_added = new User(1, "user", "noreply@noreply.com", "Jean", "Dupont", "employee", "UDS", "local", true, "etp1");
		...
		//Method addUser
		User user_added2 = new User(2, "user2", "noreply2@noreply.com", "Jean2", "Dupont2", "employee", "UDS", "ldap", true, "etp2");
