 ...
 *
 */
public class AudioSmil1 implements ISmil {
	 ...
	 */
	public AudioSmil1(Course c, String absoluteMediaFolder, String mediaFolder, String mediaFileName, ArrayList<String> timecodes) {
		this.c = c;
	...
	public void smilCreation() {
		...
		try {
			...
			/* Media display */
			pw.println("<img region=\"Bg\" src=\"" + coursesUrl + "model/bgsmia.jpg\"/>");
