  ...
  <body>
    <div class="main">
	    ...
	    <div class="contents">
	    	...
	    	<display:table id="jobs" name="jobs" requestURI="${viewurl}" class="displaytag">
	    		<display:column property="jobid" title="Job id" sortable="true"/>
	    		<display:column property="courseid" title="Course id" sortable="true"/>
	    		<display:column property="status" title="Status" sortable="true"/>
	    		<display:column property="mediatype" title="Mediatype" sortable="true"/>
	    		<display:column property="coursetype" title="Course type" sortable="true"/>
	    		<display:column property="mediapath" title="Mediapath" sortable="true"/>
	    		<display:column property="extension" title="Extension" sortable="true"/>
	    	</display:table>
	    	
	    	
	    	<br>
	    	<p class="nbr">${number} jobs</p>
	    </div>
