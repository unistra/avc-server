...
1-59/2 *        * * *   root    nice -n 19 bash /audiovideocours/cours/jobs_encodage/JobEnc.sh /audiovideocours/cours/jobs_encodage http://audiovideocast.unistra.fr /audiovideocours/cours &> /dev/null
