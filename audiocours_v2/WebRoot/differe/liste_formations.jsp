...
<html>
<head>
<title>AudioVideoCours : liste par formations</title>
...
<jsp:include page="../includes/liste_rss_formations.jsp"/>
</head>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <%
                	...
                	sqlbean.connect();
					String query_enseignants = "Select distinct \"Rating\" from \"AudioCours\" where \"Visible\"=1  AND \"Rating\" IS NOT NULL";
					
					sqlbean.query(query_enseignants);
					while( sqlbean.next() ) {
						String Rating = (String) sqlbean.getColumn("Rating");	// les formations (rangées en rating)
						%>
							<li><a href="cours_par_formation.jsp?formation=<%=Rating%>" class="Arial12boldNoir"><%=Rating%></a></li>
						<%
					}
					sqlbean.disconnect();
				%>
